...
# Create a second y-axis for LAI
ax2 = ax1.twinx()
color = 'tab:blue'
ax2.set_ylabel('Leaf Area Index (LAI)', color=color)
ax2.plot(df['Clock.Today'], df['Sorghum.Leaf.LAI'], color=color, linestyle='--', alpha=0.6, label='Max LAI')
